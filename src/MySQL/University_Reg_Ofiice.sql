...
-- show tables;
 -- drop table student;
create table student(Stu_id char(7) primary key,
Stu_name varchar(30),
stu_program varchar(20));

create table courses(course_id char(5) primary key,
course_title varchar(30),
credit int,
syllabus text,
prerequisites text);

create table course_offering(course_id char(5),
c_year year,
semester int,
section_number int,
...
create table student_score(student_id char(7),
course_id char(5),
grade int,
FOREIGN KEY(course_id) REFERENCES courses(course_id),
FOREIGN KEY(student_id) REFERENCES student(stu_id));